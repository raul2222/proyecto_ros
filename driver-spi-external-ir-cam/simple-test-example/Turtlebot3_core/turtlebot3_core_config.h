...
#include <sensor_msgs/Range.h> // incluimos la librería del mensaje range
...
#define ULTRASOUND_PUBLISH_FREQUENCY           50   //hz  //fake
...
float microsecondsToCentimeters(float microseconds); // For Ultrasound sensor
float getRange_Ultrasound(int echo_pin, int trigger_pin); // For Ultrasound sensor
